defmodule ElixirReleaseWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ElixirReleaseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ElixirReleaseWeb.Gettext, "errors", msg, opts)
    end
  end
